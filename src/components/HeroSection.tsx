...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background/95 to-background pt-20">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 z-10">
        <div className="absolute top-32 left-10 w-72 h-72 bg-heva-purple/20 rounded-full blur-3xl animate-pulse" />
      ...
      {/* Content */}
      <div className="relative z-20 container mx-auto px-6 text-center py-12">
